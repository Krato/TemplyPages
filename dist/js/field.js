...
Nova.booting(function (Vue) {
    Vue.component('detail-temply-pages-field', __webpack_require__(54));
    Vue.component('form-temply-pages-field', __webpack_require__(59));
    Vue.component('repeater-field', __webpack_require__(62));
});
...
/* scopeId */
var __vue_scopeId__ = "data-v-82131634"
/* moduleIdentifier (server only) */
...
Component.options.__file = "resources/js/field/DetailField.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-82131634", Component.options)
  } else {
    hotAPI.reload("data-v-82131634", Component.options)
  }
...
var update = __webpack_require__(2)("30400ad2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-82131634\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailField.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-82131634\",\"scoped\":true,\"hasInlineConfig\":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./DetailField.vue");
...
// module
exports.push([module.i, "\n.section-header[data-v-82131634]{\n    margin-left: -24px;\n    width: calc(100% + 48px);\n}\n\n", ""]);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getInfo: function getInfo() {
            ...
            this.resource.fields.forEach(function (component) {
                if (component.attribute == 'template') {
                    _this.templateId = component.belongsToId;
                }
            });
        ...
        getTemplateFieldsWithValues: function getTemplateFieldsWithValues(templateId) {
            var _this2 = this;

            return __WEBPACK_IMPORTED_MODULE_0__api_js__["a" /* default */].getTemplateFieldsWithValues(this.resourceId, templateId).then(function (result) {
                _this2.sections = result.sections;
                _this2.fieldValues = result.values;
            });
        },
        getPageInfo: function getPageInfo() {
            var _this3 = this;

            return __WEBPACK_IMPORTED_MODULE_0__api_js__["a" /* default */].pageInfo(this.resourceId).then(function (page) {
                _this3.page = page;
            });
        },
        isCustomOrEmpty: function isCustomOrEmpty(section) {
            if (this.isCustom) {
                return true;
            }
  ...
  return _c(
    ...
    [
      _vm._l(_vm.sections, function(section) {
        return !_vm.isCustomOrEmpty(section)
          ? _c(
              "div",
              { key: section.name },
              [
                _c(
                  ...
                  {
                    staticClass:
                      "section-header p-4 text-90 border-b border-40 flex justify-between items-center bg-30"
                  },
                  [
                    _c(
                      "h1",
                      { staticClass: "font-normal text-xl capitalize" },
                      [_vm._v(_vm._s(section.name))]
                    )
                  ]
                ),
                _vm._v(" "),
                _vm._l(section.children, function(children, key, index) {
                  return [
                    _c(
                      "div",
                      { key: key, staticClass: "w-full" },
                      [
                        children.field.attribute == "repeater"
                          ? [
                              _c("repeater-field", {
                                attrs: {
                                  realId: key,
                                  field: children,
                                  parentIndex: index,
                                  values: _vm.fieldValues
                                }
                              })
                            ]
                          : _c(children.field.vue, {
                              tag: "component",
                              attrs: {
                                errors: _vm.errors,
      ...
      _vm.isCustom
        ? _c("div", { staticClass: "flex border-b border-40" }, [
            _c("div", { staticClass: "flex items-center w-1/4 py-4" }, [
            ...
            _c("div", { staticClass: "w-3/4 py-4" }, [
              _c(
                ...
                [_vm._v(_vm._s(_vm.__("Click here to edit")))]
              )
            ])
          ])
        : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-82131634", module.exports)
  }
}
...
Component.options.__file = "resources/js/field/FormField.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-874511da", Component.options)
  } else {
    hotAPI.reload("data-v-874511da", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_laravel_nova__ = __webpack_require__(10);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    mixins: [__WEBPACK_IMPORTED_MODULE_2_laravel_nova__["FormField"], __WEBPACK_IMPORTED_MODULE_2_laravel_nova__["HandlesValidationErrors"]],
    ...
    methods: {
        getPageInfo: function getPageInfo() {
            ...
            return __WEBPACK_IMPORTED_MODULE_1__api_js__["a" /* default */].pageInfo(this.resourceId).then(function (page) {
                _this.page = page;
                if (_this.page.isCustom) {
                    _this.isCustom = true;
                }

                _this.registerDependencyWatchers(_this.$parent);
            });
        },
        registerDependencyWatchers: function registerDependencyWatchers(parent) {
            var _this2 = this;

            parent.$children.forEach(function (component) {
                if (_this2.componentIsDependency(component)) {
                    component.$watch('selectedResource.value', function (value) {
                        _this2.templateId = value;
                        _this2.updateTemplateFields();
                    }, { immediate: true });

                    setTimeout(function () {
                        return component.field.resourceName = undefined;
                    }, 500);
        ...
        getFieldsFromTemplate: function getFieldsFromTemplate(templateId) {
            var _this3 = this;

            return __WEBPACK_IMPORTED_MODULE_1__api_js__["a" /* default */].getTemplateFields(this.resourceId, templateId).then(function (result) {
                _this3.sections = result.sections;
                _this3.fieldValues = result.values;
            });
        },
        ...
        addWatcher: function addWatcher(children) {
            var _this4 = this;

            if (children.field.component == 'file-field') {
                children.$watch('file', function (value) {
                    if (value) {
                        ...
                        reader.onloadend = function () {
                            ...
                            _this4.setNewValue(children.field.key, newValue);
                        };
                    }
                }, { immediate: true });
            } else {
                children.$watch('value', function (value) {
                    var key = children.field.key;
                    if (children.$vnode.data.key) {
                        key = children.$vnode.data.key;
                    }
                    if (value) {
                        _this4.setNewValue(key, value);
                    } else {
                        _this4.setNewValue(key, '');
                    }
                }, { immediate: true });
            }
        },
        checkChildren: function checkChildren(childrens, parent) {
            var _this5 = this;

            childrens.forEach(function (children) {
                if (children.type == 'repeater') {
                    _this5.checkChildren(children.$children, '');
                    // _.forEach(children.field.children, childrenRepeater => {

                    // })
                }

                _this5.addWatcher(children, parent);
            });
        },
        setNewValue: function setNewValue(key, val) {
    ...
    watch: {
        sections: function sections(_sections) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.size(_sections) > 0) {
                setTimeout(function () {
                    return _this6.checkChildren(_this6.$children, '');
                }, 1000);
            }
        }
    }
          ...
          ? _c(
              ...
              [
                _c(
                  ...
                  {
                    staticClass:
                      "p-4 text-90 border-b border-40 flex justify-between items-center bg-30"
                  },
                  [
                    _c(
                      "h1",
      ...
      _vm.isCustom
        ? _c("div", {}, [
            _c(
              ...
              [
                _c("h1", { staticClass: "font-normal text-xl capitalize" }, [
                  _vm._v(_vm._s(_vm.__("Custom Page")))
                ])
              ]
            ),
            _vm._v(" "),
            _c("div", { staticClass: "flex border-b border-40" }, [
              _c("div", { staticClass: "flex items-center w-1/5 py-6 px-8" }, [
                _c("h4", { staticClass: "font-normal text-80" }, [
                  _vm._v(
                    "\n                    " +
                      _vm._s(_vm.__("Edit Page")) +
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-874511da", module.exports)
  }
}
...
Component.options.__file = "resources/js/field/RepeaterField.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3de4264f", Component.options)
  } else {
    hotAPI.reload("data-v-3de4264f", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getKey: function getKey(number, indexRepeater, field) {
        ...
        getField: function getField(field, number, indexRepeater, childrenRepeater) {
            var key = this.getKey(number, indexRepeater, childrenRepeater);
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _vm._l(_vm.field.field.repeatTimes, function(number) {
        return [
          _c(
            "div",
            {
              ...
              staticClass:
                "p-4 m-4 text-90 border-b border-40 flex justify-between items-center bg-30"
            },
            [
              _c("h1", { staticClass: "font-normal text-xl capitalize" }, [
                _vm._v(_vm._s(_vm.field.field.name) + " " + _vm._s(number))
              ])
            ]
          ),
          _vm._v(" "),
          _vm._l(_vm.field.children, function(
            childrenRepeater,
            keyRepeater,
            indexRepeater
          ) {
            return [
              childrenRepeater.field.attribute == "repeater"
                ? [
                    _c(
                      "div",
                      {
                        key: "repeater_" + keyRepeater + "_" + number,
                        staticClass: "w-5/6 ml-auto",
                        attrs: {
                          rel: keyRepeater,
                          index: indexRepeater,
                          parentIndex: number
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3de4264f", module.exports)
  }
}
