...
<ul class="list-reset mb-8">
    ...
    <li class="leading-wide mb-4 text-sm">
        <router-link :to="{name: 'temply-pages.pages'}" class="text-white ml-8 no-underline dim">
            {{ __('Pages') }}
        </router-link>
    </li>

    <li class="leading-wide mb-4 text-sm">
        <router-link :to="{name: 'temply-pages.templates'}" class="text-white ml-8 no-underline dim">
            {{ __('Templates') }}
        </router-link>
    </li>
