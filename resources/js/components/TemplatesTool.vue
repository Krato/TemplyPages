    ...
    <div class="">
                    ...
                    <div class="bg-white w-full section rounded shadow-md p-4">
                        <div class="flex flex-wrap mb-4">
                            ...
                            <div class="flex flex-col w-2/3  justify-between">
                                <h5 class="text-70 font-medium uppercase">
                                    {{ section.count }} {{ __('templates') }}
                                </h5>
        ...
        <div id="options" class="px-2" v-if="selectedSection">
            <div class="flex flex-wrap justify-between">
                ...
                <div
                    class="inline-block bg-primary rounded-lg cursor-pointer"
                    @click="newPage"
                    v-if="previewUrl"
                >
                    <div class="flex flex-wrap text-white px-4 py-4">
                        ...
                        >
                            <div class="flex flex-wrap">
                                ...
                                <div class="flex flex-col w-2/3  justify-center">
                                    <h5 class="text-70 font-medium uppercase">
                                        {{ selectedSection.name }} {{ __('template') }}
                                    </h5>
            ...
            >
                ...
                <div slot="buttons">
                    <div class="ml-auto">
                        <button
                            type="button"
                            @click.prevent="modalConfirm = !modalConfirm"
